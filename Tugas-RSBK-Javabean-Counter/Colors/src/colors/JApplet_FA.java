 ...
 * @author ASUS
 */
public class JApplet_FA extends javax.swing.JApplet {

    /**
     * Initializes the applet JApplet_FA
     */
    @Override
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JApplet_FA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
